...
const bn: Dict = {
  ...
  'emergency.callNow': 'দয়া করে এখনই ১০৮ নম্বরে ফোন করুন, বা কাছের হাসপাতালে যান।',
};
...
const mr: Dict = {
  ...
  'emergency.callNow': 'कृपया आत्ताच १०८ वर फोन करा, किंवा जवळच्या रुग्णालयात जा.',
};
...
const as: Dict = {
  ...
  'emergency.callNow': 'অনুগ্ৰহ কৰি এতিয়াই ১০৮ নম্বৰত ফোন কৰক, বা ওচৰৰ চিকিৎসালয়লৈ যাওক।',
};
